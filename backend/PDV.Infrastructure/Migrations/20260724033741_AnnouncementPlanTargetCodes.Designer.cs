...
namespace PDV.Infrastructure.Migrations
{
    ...
    [Migration("20260724033741_AnnouncementPlanTargetCodes")]
    partial class AnnouncementPlanTargetCodes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PDV.Domain.Entities.Announcement", b =>
                {
                    ...
                    b.HasIndex("IsActive", "PublishAt", "ExpiresAt");
            ...
            modelBuilder.Entity("PDV.Domain.Entities.ContactMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("PDV.Domain.Entities.Employee", b =>
                {
                    ...
                    b.Property<bool>("AutoCreateSalaryExpense")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("PDV.Domain.Entities.EmployeeSalaryLink", b =>
                {
                    b.Property<Guid>("EmployeeId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("PDV.Domain.Entities.Plan", b =>
                {
                    ...
                    b.Property<string>("EntitledModulesJson")
                        .IsRequired()
                        .HasColumnType("json");
            ...
            modelBuilder.Entity("PDV.Domain.Entities.ServiceProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("PDV.Domain.Entities.SystemLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("PDV.Domain.Entities.TenantSettings", b =>
                {
                    ...
                    b.Property<bool>("AllowCustomAppointmentPrice")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<string>("CustomSegmentName")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");

                    b.Property<int>("DefaultCriticalStock")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(2);
                    ...
                    b.Property<bool>("InventoryControlEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                    ...
                    b.Property<bool>("StockFieldsEditable")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("PDV.Domain.Entities.EmployeeSalaryLink", b =>
                {
                    b.HasOne("PDV.Domain.Entities.Employee", "Employee")
                        .WithOne()
                        .HasForeignKey("PDV.Domain.Entities.EmployeeSalaryLink", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PDV.Domain.Entities.Expense", b =>
                {
                    b.HasOne("PDV.Domain.Entities.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeeId")
