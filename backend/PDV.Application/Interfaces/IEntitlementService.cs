...
// quando não dá direito (ex.: expirada) — nesse caso `Plan` é null e Modules/Limits ficam vazios
// (sem plano Free permanente), bloqueando todo módulo gateado com 402.
...
// atual e lê a assinatura viva dele; sem assinatura válida → sem módulos (acesso bloqueado).
