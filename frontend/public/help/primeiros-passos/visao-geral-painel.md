...
O menu é dividido em duas seções:
...
É a primeira tela ao entrar no sistema. No topo, os KPIs do período mostram **Faturamento**, **Despesas** e **Lucro estimado** — e, com o plano Pro, também **Estoque baixo**.

Com o plano **Pro**, dois botões no cabeçalho permitem alternar a visão:
...
O botão **Nova venda**, sempre visível no topo da tela Início, leva direto para a tela de Vender.

## Precisa de ajuda?

O botão **Ajuda**, no menu lateral, abre esta central de ajuda a qualquer momento — a maioria das páginas também tem um atalho direto para o artigo relacionado àquela tela.
