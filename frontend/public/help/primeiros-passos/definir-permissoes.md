...
O acesso de cada pessoa é controlado por dois eixos independentes: **o que o negócio usa** (módulos) e **o que a pessoa pode fazer** (papel e permissões).
...
- Módulo desativado → a área some para **todo mundo**, sem exceção.
- Permissão não marcada no papel → aquele funcionário específico não vê ou não pode agir naquela área, mesmo que o módulo esteja ativo.
