...
## Reagendando um agendamento

Na visualização em **calendário** (ícone de calendário no topo da agenda), arraste o agendamento para outro horário ou profissional, ou puxe pela borda para alterar a duração. A alteração é salva automaticamente — não é preciso confirmar em um modal separado.
...
- Agendamentos **cancelados** ou **concluídos** não podem mais ser movidos, redimensionados ou ter o status alterado.
- Pelo modal de detalhes também é possível abrir o WhatsApp do cliente diretamente, se houver telefone cadastrado.
