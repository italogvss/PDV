...
Cadastre os clientes do seu negócio para vinculá-los a vendas e agendamentos, e acompanhar o histórico de cada um.

## Passo a passo

1. Acesse **Clientes** no menu lateral.
2. Clique em **Novo cliente**.
3. Preencha o **Nome completo** — único campo obrigatório.
4. Complete com **Telefone**, **E-mail** e **CPF / CNPJ**, se desejar.
...
- Também é possível criar um cliente diretamente durante uma venda ou um agendamento — veja o artigo *Vincular cliente a uma venda*.
