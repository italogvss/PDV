...
1. Em **Despesas**, clique em **Nova despesa** (ou edite uma existente).
2. Preencha os dados normais da despesa (categoria, descrição, valor, vencimento).
3. Ative **Despesa recorrente mensal**.
4. Em **Repetir por quantos meses?**, informe um número (ex.: 12) para uma quantidade fixa de repetições, ou deixe em branco para repetir **indefinidamente**.
5. Clique em **Salvar**.

## Onde acompanhar

- Na lista de despesas, itens recorrentes ganham um selo **"Renova mensalmente"** ao lado da descrição.
...
## Excluindo uma despesa recorrente
