...
Adicione um membro da equipe com login próprio e acesso limitado pelo papel escolhido.

## Passo a passo

1. Acesse **Funcionários** no menu lateral.
2. Clique em **Novo funcionário**.
3. Preencha **Nome completo**, **Nome de usuário** (usado para entrar no sistema — apenas letras, números, ponto e underscore) e **E-mail**.
4. Defina uma **Senha temporária** (mínimo 8 caracteres, com pelo menos um número e um caractere especial). O funcionário será obrigado a trocá-la no primeiro acesso.
5. Escolha o **Papel** — define quais permissões o funcionário terá (veja o artigo *Criar cargos e permissões*).
