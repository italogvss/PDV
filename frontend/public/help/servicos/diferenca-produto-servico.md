...
Use **produto** para qualquer item físico controlado por quantidade (mercadoria, insumo revendido). Use **serviço** para mão de obra, atendimento ou qualquer coisa que tenha duração e não dependa de estoque — especialmente se o negócio usa a agenda para marcar horários.
