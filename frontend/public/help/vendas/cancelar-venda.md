...
1. Acesse **Vendas > Histórico** (ou clique em **Histórico** na própria tela de Vender).
...
- Os itens da venda voltam automaticamente ao estoque.
- A venda passa a exibir o status **Cancelado**, junto com quem cancelou e a data/hora do cancelamento, visíveis no detalhe da venda.
- Uma venda já cancelada não pode ser cancelada novamente — a opção some do menu de ações.
