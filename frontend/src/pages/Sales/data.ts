...
export const PRODUCTS: Product[] = [
  ...
  { id: '13', name: 'Café espresso 50g',       price: 6.0,  category: 'bebidas',   imageColor: '#c9a37a' },
  { id: '14', name: 'Pão de queijo (unid.)',   price: 4.5,  category: 'padaria',   imageColor: '#e8d4a8' },
  { id: '15', name: 'Bolo de cenoura fatia',   price: 7.5,  category: 'padaria',   imageColor: '#e6a55c' },
  { id: '16', name: 'Refrigerante lata 350ml', price: 8.0,  category: 'bebidas',   imageColor: '#a8c5d4' },
  { id: '17', name: 'Suco natural laranja',    price: 9.0,  category: 'bebidas',   imageColor: '#f0a04b' },
  { id: '18', name: 'Sanduíche frango',        price: 16.0, category: 'lanches',   imageColor: '#d4a574' },
  { id: '19', name: 'Sanduíche vegetal',       price: 14.0, category: 'lanches',   imageColor: '#a8c994' },
  { id: '20', name: 'Salada Caesar',           price: 18.0, category: 'lanches',   imageColor: '#a8c594' },
  { id: '21', name: 'Brownie c/ sorvete',      price: 12.0, category: 'sobremesa', imageColor: '#6b4423' },
  { id: '22', name: 'Cookie chocolate',       price: 5.0,  category: 'sobremesa', imageColor: '#8b5a2b' },
  { id: '23', name: 'Água mineral 500ml',     price: 4.0,  category: 'bebidas',   imageColor: '#cfe6ec' },
  { id: '24', name: 'Cappuccino',             price: 8.5,  category: 'bebidas',   imageColor: '#b8946b' },
]
