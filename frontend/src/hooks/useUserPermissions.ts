...
// Eixo de ACCESS CONTROL (tenant/role): o que o Employee pode fazer + módulos que o Owner exibe.
// NÃO inclui estado de billing — o plano nunca esconde/desabilita a UI; o backend bloqueia com 402.
